"""
Django settings for prd_approval_test__117537 project.
...
ROOT_URLCONF = 'prd_approval_test__117537.urls'
...
WSGI_APPLICATION = 'prd_approval_test__117537.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_approval_test__117537 API",
    "DESCRIPTION": "API documentation for prd_approval_test__117537 App",
    "VERSION": "v1",
}
